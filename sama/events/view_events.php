            ...
            <?php while ($row = $result->fetch_assoc()): ?>
                <tr>
                    <td class="border px-3 py-1">
                        <a href="event_detail.php?id=<?= $row['id'] ?>" class="text-blue-600 hover:underline">
                    ...
                    <td class="border px-3 py-1 text-center">
                        ...
                        ?>
                        <?php if ($canEdit): ?>
                            <a href="edit_event.php?id=<?= $row['id'] ?>" class="text-yellow-600 hover:underline mr-2">Edit</a>
                        <?php endif; ?>
                        <?php if ($canDelete): ?>
                            <a href="delete_event.php?id=<?= $row['id'] ?>" onclick="return confirm('Delete this event?')" class="text-red-600 hover:underline">Delete</a>
                        <?php endif; ?>
                    </td>
                </tr>
            <?php endwhile; ?>
